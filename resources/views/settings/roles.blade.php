<x-app-layout>
    ...
    <div class="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div class="flex items-center space-x-2 text-xs text-slate-500 font-medium">
            ...
            <span>&rsaquo;</span>
            <span class="text-slate-900 font-bold">Role Management</span>
        </div>
            ...
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 font-medium">Define operational authority, assign primary permission actions, and maintain organizational roles</p>
                    </div>
                </div>
            </div>
            <button onclick="openAddRoleModal()" class="px-3.5 py-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-lg transition shadow-sm flex items-center gap-1.5 self-start sm:self-auto">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div class="p-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-bold text-slate-900">Role & Primary Permissions Matrix</h2>
                    <p class="text-xs text-slate-500">System roles, access tiers, and primary actions</p>
                </div>
